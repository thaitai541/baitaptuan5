...
List<Place> placelist = [
  Place(
      image: "assets/place1.jpeg",
      name: "Light House Island",
      location: "National Park of Ireland"),
  Place(
      image: "assets/mountain.jpeg",
      name: "Exotic Mountains",
      location: "Jubilee Hills"),
  Place(
      image: "assets/night.jpeg",
      name: "Cross Valley Lake",
...
List<Pcategory> pcategorylist = [
  ...
  Pcategory(
      name: "Camping", color: const Color(0xff9fd0f6), icon: Icons.campaign),
  Pcategory(
      name: "Car", color: const Color(0xffd0bcf2), icon: Icons.directions_car),
  Pcategory(
      name: "Food", color: const Color(0xfff9ced0), icon: Icons.brunch_dining)
];
